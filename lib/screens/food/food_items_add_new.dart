...
class FoodItemsAddNew extends StatefulWidget {
  final Function onSelectImage;

  FoodItemsAddNew(this.onSelectImage);

  @override
  _FoodItemsAddNewState createState() => _FoodItemsAddNewState();
}

class _FoodItemsAddNewState extends State<FoodItemsAddNew> {
  File _storedImage;
  void _upload() {
    ...
    http.post('https://fcea7757.ngrok.io/prediction', body: {
      "image": base64Image,
      "name": fileName,
    }).then((res) {
